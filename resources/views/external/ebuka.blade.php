			...
			<div class="row">
				<div class="col s12 vid-cont">
					...
					<div class="col s12 m6 pad0 white watis">
						<div class="center">
							<h5 class="black-text text-uppercase">Ebuka Obi-Uchendu </h5>

							<p class="pry-color det">
								&quot; I've always been interested in farming & agriculture but never really knew where 
								or how to get involved without fully leaving my day job. Which is why partnering with 
								PorkMoney deeply interests me.
							</p>

							<p class="pry-color det">
								I invite you to come on this journey like me as we all make money & chop well.&quot;
							</p>
						</div>
					</div>
				</div>

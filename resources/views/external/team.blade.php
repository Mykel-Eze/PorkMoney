        ...
        <div class="row">
            <div class="container">
                ...
                <div class="imgs col s12">
                    ...
                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-015">
                        <img src=" img/headshots/PorkMoney- 015.jpg" alt="img-team">
                        <h4 class="pry-color">Odebunmi Tope</h4>
                        <span>HOD. Operations</span>
                    </div>

                    <div class="col s6 m3 center-align img" data-target="linda*">
                        <img src=" img/headshots/Lillian.jpg" alt="img-team">
                        <h4 class="pry-color">Obi Linda</h4>
                        <span>COO</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-003">
                        <img src=" img/headshots/PorkMoney- 003.jpg" alt="img-team">
                        <h4 class="pry-color">Nwandu Sarah</h4>
                        <span>Tech</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-004">
                        <img src=" img/headshots/PorkMoney- 004.jpg" alt="img-team">
                        <h4 class="pry-color">Eze Michael</h4>
                        <span>Tech</span>
                    </div>

                    <div class="col s6 m3 center-align img" data-target="PorkMoney-024*">
                        <img src=" img/headshots/PorkMoney- 024.jpg" alt="img-team">
                        <h4 class="pry-color">Folorunso Sinmi</h4>
                        <span>Operations Executive</span>
                    </div>
                    

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-007">
                        <img src=" img/headshots/PorkMoney- 007.jpg" alt="img-team">
                        <h4 class="pry-color">Michael Akpan</h4>
                        <span>Partner Relations</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="boss">
                        <img src=" img/headshots/Folorunsho.jpg" alt="img-team">
                        <h4 class="pry-color">Folorunso Muyiwa</h4>
                        <span>CEO/Co-founder</span>
                    </div>

                    <div class="col s6 m3 center-align img" data-target="PorkMoney-002*">
                        <img src=" img/headshots/PorkMoney- 002.jpg" alt="img-team">
                        <h4 class="pry-color">Adeloye Ajibade</h4>
                        <span>Graphics Design</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-008">
                        <img src=" img/headshots/PorkMoney- 008.jpg" alt="img-team">
                        <h4 class="pry-color">Akindeji Seun</h4>
                        <span>Social Media</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-009">
                        <img src=" img/headshots/PorkMoney- 009.jpg" alt="img-team">
                        <h4 class="pry-color">Adeosun Muyiwa</h4>
                        <span>Creative</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-010">
                        <img src=" img/headshots/PorkMoney- 010.jpg" alt="img-team">
                        <h4 class="pry-color">Duyile Niyi</h4>
                        <span>Creative</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-011">
                        <img src=" img/headshots/PorkMoney- 011.jpg" alt="img-team">
                    ...
                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-012">
                        <img src=" img/headshots/PorkMoney- 012.jpg" alt="img-team">
                        <h4 class="pry-color">John Jackson</h4>
                        <span>Creative</span>
                    </div>
                    
                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-025">
                        <img src=" img/headshots/PorkMoney- 025.jpg" alt="img-team">
                        <h4 class="pry-color">Ajiboye Abiola</h4>
                        <span>Admin</span>
                    </div>

                    <div class="col s6 m3 center-align img" data-target="PorkMoney-026*">
                        <img src=" img/headshots/PorkMoney- 026.jpg" alt="img-team">
                        <h4 class="pry-color">Iselobhor Vincent</h4>
                        <span>Procurement</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-016">
                        <img src=" img/headshots/PorkMoney- 016.jpg" alt="img-team">
                        <h4 class="pry-color">Ndakson Patience</h4>
                        <span>Partner Relations</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-017">
                        <img src=" img/headshots/PorkMoney- 017.jpg" alt="img-team">
                        <h4 class="pry-color">Adedoyin Ayomide</h4>
                        <span>Partner Relations</span>
                    </div>

                    <!-- <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-018">
                        <img src=" img/headshots/PorkMoney- 018.jpg" alt="img-team">
                        <h4 class="pry-color">Aladeojebi Israel</h4>
                        <span>Sales</span>
                    </div>  -->

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-019">
                        <img src=" img/headshots/PorkMoney- 019.jpg" alt="img-team">
                        <h4 class="pry-color">Amosu Tosin</h4>
                        <span>Partner Relations</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-020">
                        <img src=" img/headshots/PorkMoney- 020.jpg" alt="img-team">
                        <h4 class="pry-color">Ehimai Bernard</h4>
                        <span>Partner Relations</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-021">
                        <img src=" img/headshots/PorkMoney- 021.jpg" alt="img-team">
                        <h4 class="pry-color">Chibututu Wilson</h4>
                        <span>Partner Relations</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-022">
                        <img src=" img/headshots/PorkMoney- 022.jpg" alt="img-team">
                        <h4 class="pry-color">Aluko Samuel</h4>
                        <span>Partner Relations</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-023">
                        <img src=" img/headshots/PorkMoney- 023.jpg" alt="img-team">
                        <h4 class="pry-color">Ojo Ayorinde</h4>
                        <span>Partner Relations</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-027">
                        <img src=" img/headshots/PorkMoney- 027.jpg" alt="img-team">
                        <h4 class="pry-color">Ogberega Judith</h4>
                        <span>Partner Relations</span>
                    </div>

                    <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-028">
                        <img src=" img/headshots/PorkMoney- 028.jpg" alt="img-team">
                        <h4 class="pry-color">Gbolahan Olubukola</h4>
                        <span>Legal</span>
                    </div>

                    <!-- <div class="col s6 m3 center-align img modal-trigger" data-target="PorkMoney-029">
                        <img src=" img/headshots/PorkMoney- 029.jpg" alt="img-team">
                    ...
                    <div class="row">
                        <div class="col s12">
                            ...
                            <div class="col s12 m8">
                                ...
                                <p>
                                    She currently works for Pork Money a branch of Divergent Enterprise as a human resource director, were she 
                                    manages the affairs of both Nigeria and Ghana resources.  
                                </p>

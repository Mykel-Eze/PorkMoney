...
<head>
    ...
    <title>PorkMoney - Set Passoword</title>
...
<body class="rel">
    ...
    <div class="section">
        ...
        <div class="container">
            <div class="row">
                <h4 class="center-align head-txt">SET PASSWORD</h4>
                <div  class="col s12 m4 offset-m4 form-div">
                    <form method="POST" action="{{ url('/registration/add-password') }}">
                        @csrf

                        <input type="hidden" name="user_id" value={{ old('user_id') != null? old('user_id') : Session::get('user')->id}}>
